...
from .views import CourseListView, CourseCreateView, CourseEditView, CourseDetailView, updateModule, createModule, deleteModule
...
urlpatterns = [
    ...
    path('module/<int:course_id>/<int:module_id>/delete/', deleteModule, name='delete-module'),
